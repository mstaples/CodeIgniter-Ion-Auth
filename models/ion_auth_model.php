...
class Ion_auth_model extends CI_Model
{
    ...
    protected function getDelimiters() {
        $this->load->library('export_delimiters');

        $this->error_end_delimiter = $this->export_delimiters->getErrorSuffix();
        $this->error_start_delimiter = $this->export_delimiters->getErrorPrefix();

        $this->message_start_delimiter = $this->export_delimiters->getMessagePrefix();
        $this->message_end_delimiter = $this->export_delimiters->getMessageSuffix();
